...
wineobsApp.controller('reservationModalController', function ($scope,$rootScope,$modal, reservation){
...
wineobsApp.controller('ModalGalleryController', function($rootScope, $scope, $modalInstance, images, wineryId){
	$scope.images = images;
